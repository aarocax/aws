...
class BaseController {
    ...
    protected function logInfo($message, $methodNameComplete=''): void
    {
        $this->logWithMethod('info', $message, $methodNameComplete);
    }

    protected function logError($message, $sendEmail=false, $methodNameComplete=''): void
    {
    ...
    protected function logWithMethod($level, $message, $methodNameComplete=''): void
    {
        try {
    ...
    // logar
    private function logText($level, $text): void
    {
        switch($level) {
            case 'info':
