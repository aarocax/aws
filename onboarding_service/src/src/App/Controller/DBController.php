...
class DBController extends BaseController implements ControllerInterface
{
  ...
  public function update(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET state=%d, last_update='%s', library_document_id='%s', xpressid_validation_id='%s', document_type=%s WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["state"],
      $data["last_update"],
  ...
  public function updateState(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET state=%d, last_update='%s', webhook_timestamp=%d WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["state"],
      $data["last_update"],
  ...
  public function updateStateBoidasToAtfinity(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET state=%d, last_update='%s', webhook_timestamp=%d, boidas_to_atfinity=%d WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["state"],
      $data["last_update"],
      $data["webhook_timestamp"],
  ...
  public function updateAtfinityInstanceFieldsId(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET atfinity_instance_fields_id=%d, last_update='%s' WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
  ...
  public function getDataWhereAtfinity(array $data)
  {
    ...
    $query = sprintf("SELECT  * FROM %s.onboarding WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["case_id"],
      $data["instance_id"]
    );
  ...
  public function getDataWhereValidationId(array $data)
  {
    ...
    $query = sprintf("SELECT  * FROM %s.onboarding WHERE xpressid_validation_id='%s'", 
      AppConfig::getInstance()->getValue("DB_NAME"), 
      $data["validation_id"]
    );
  ...
  public function getDataWhereSignatureRequestId(array $data)
  {
    ...
    $query = sprintf("SELECT  * FROM %s.onboarding WHERE signature_request_id='%s'", 
      AppConfig::getInstance()->getValue("DB_NAME"),
  ...
  public function getDataWhereState(array $data)
  {
    ...
    $query = sprintf("SELECT  * FROM %s.onboarding WHERE state in (%s) AND webhook_timestamp <= unix_timestamp(now()) AND boidas_to_atfinity = 0",
      AppConfig::getInstance()->getValue("DB_NAME"),
      implode(',', $data["state"])
    );
  ...
  public function updateDataError(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET data_error='%s' WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["data_error"],
      $data["case_id"],
      $data["instance_id"]
  ...
  public function resetCountError(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET count_error=0 WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["case_id"],
      $data["instance_id"]
    );
  ...
  public function updateCountError(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET count_error=count_error+1 WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["case_id"],
      $data["instance_id"]
    );
  ...
  {
    $query = sprintf("SELECT  * FROM %s.retargeting WHERE onboarding_id=%d AND atfinity_case_id=%d AND counter < 6 AND counter > -1",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["onboarding_id"],
  ...
  {
    $query = sprintf("UPDATE %s.onboarding SET retargeting=%d WHERE atfinity_case_id=%d AND atfinity_instance_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["retargeting"],
      $data["atfinity_case_id"],
  ...
  public function updateCounterField(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.retargeting SET counter=%d WHERE id=%d AND atfinity_case_id=%d AND onboarding_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $counter,
      $data["retargeting_id"],
      $data["atfinity_case_id"],
  ...
  {
    $query = sprintf("UPDATE %s.retargeting SET counter=%d WHERE atfinity_case_id=%d AND onboarding_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["counter"],
      $data["atfinity_case_id"],
      $data["onboarding_id"]
  ...
  public function updateSignatureRequestId(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET signature_request_id='%s' WHERE xpressid_validation_id='%s'",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["signature_request_id"],
      $data["validation_id"]
    );
  ...
  {
    $query = sprintf("SELECT * FROM %s.onboarding WHERE state=%d and prospects=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $state = 4,
      $prospects = 0
    );
  ...
  public function updateProspectField(array $data)
  {
    ...
    $query = sprintf("UPDATE %s.onboarding SET prospects=%d WHERE id=%d AND atfinity_case_id=%d",
      AppConfig::getInstance()->getValue("DB_NAME"),
      $data["send"],
      $data["onboarding_id"],
      $data["atfinity_case_id"]
